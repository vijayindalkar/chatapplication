import type { InstaQLEntity, InstaQLResult, InstaQLParams, Remove$ } from "./queryTypes";
 ...
 */
export type InstantQuery<DB extends IInstantDatabase<any>> = DB extends IInstantDatabase<infer Schema> ? InstaQLParams<Schema> : never;
/**
 * @deprecated
 ...
 */
export type InstantQueryResult<DB extends IInstantDatabase<any>, Q> = DB extends IInstantDatabase<infer Schema> ? InstaQLResult<Schema, Remove$<Q>> : never;
/**
 * @deprecated
 ...
 * type Schema = typeof schema;
 */
export type InstantSchema<DB extends IInstantDatabase<any>> = DB extends IInstantDatabase<infer Schema> ? Schema : never;
/**
 * @deprecated
 ...
 */
export type InstantEntity<DB extends IInstantDatabase<any>, EntityName extends DB extends IInstantDatabase<infer Schema> ? Schema extends IContainEntitiesAndLinks<infer Entities, any> ? keyof Entities : never : never, Query extends (DB extends IInstantDatabase<infer Schema> ? Schema extends IContainEntitiesAndLinks<infer Entities, any> ? {
    [QueryPropName in keyof Entities[EntityName]["links"]]?: any;
} : never : never) | {} = {}> = DB extends IInstantDatabase<infer Schema> ? InstaQLEntity<Schema, EntityName, Query> : never;
/**
 * @deprecated
 ...
 */
export type InstantSchemaDatabase<Schema extends InstantSchemaDef<any, any, any>, _T1 extends any = any, _T2 extends any = any> = IInstantDatabase<Schema>;
