...
export default abstract class InstantReactAbstractDatabase<Schema extends InstantSchemaDef<any, any, any>, Rooms extends RoomSchemaShape = RoomsOf<Schema>> implements IInstantDatabase<Schema> {
     ...
     */
    useQuery: <Q extends InstaQLParams<Schema>>(query: null | Q) => InstaQLLifecycleState<Schema, Q>;
    /**
