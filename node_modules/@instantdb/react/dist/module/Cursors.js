...
function Cursor({ color }) {
    ...
    return (_jsxs("svg", { style: { height: size, width: size }, viewBox: `0 0 ${size} ${size}`, fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [_jsxs("g", { fill: "rgba(0,0,0,.2)", transform: "matrix(1, 0, 0, 1, -11.999999046325684, -8.406899452209473)", children: [_jsx("path", { d: "m12 24.4219v-16.015l11.591 11.619h-6.781l-.411.124z" }), _jsx("path", { d: "m21.0845 25.0962-3.605 1.535-4.682-11.089 3.686-1.553z" })] }), _jsxs("g", { fill: "white", transform: "matrix(1, 0, 0, 1, -11.999999046325684, -8.406899452209473)", children: [_jsx("path", { d: "m12 24.4219v-16.015l11.591 11.619h-6.781l-.411.124z" }), _jsx("path", { d: "m21.0845 25.0962-3.605 1.535-4.682-11.089 3.686-1.553z" })] }), _jsxs("g", { fill: fill, transform: "matrix(1, 0, 0, 1, -11.999999046325684, -8.406899452209473)", children: [_jsx("path", { d: "m19.751 24.4155-1.844.774-3.1-7.374 1.841-.775z" }), _jsx("path", { d: "m13 10.814v11.188l2.969-2.866.428-.139h4.768z" })] })] }));
}
const absStyles = {
    position: "absolute",
    top: 0,
